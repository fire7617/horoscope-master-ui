      ...
      <el-form ref="form" :model="form"  label-width="80px">
        ...
        <el-form-item label="小類" prop="subStatus">
          <el-select v-model="form.subStatus" >
            ...
            <el-option v-if="form.subType==='2'" v-for="item in loveOption" :key="item.value" :label="item.label" :value="item.value"/>
            <el-option v-if="form.subType==='6'" v-for="item in careerOption" :key="item.value" :label="item.label" :value="item.value"/>
            <el-option v-if="form.subType==='5'" v-for="item in welthOption" :key="item.value" :label="item.label" :value="item.value"/>
          </el-select>
        </el-form-item>
